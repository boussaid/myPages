...
class Mypages_DataWriter_MyPages extends XenForo_DataWriter
{
	 ...
	 * @var string
	 */
	protected $_existingDataErrorPhrase = 'requested_my_page_not_found';
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('xf_my_page' => $this->_getMyPagesModel()->getMyPageById($id));
	}
	...
	*/
	...
	protected function _verifyPageName(&$data)
	{
		...
		$page = $this->_getMyPagesModel()->getMyPageByName($data);
	...
	protected function _postSave()
	{
		...
		if ($content !== null)
		{
			$template = $this->_getMyPagesModel()->getMyPageTemplate($pageId);
			...
			$templateWriter->set('title', $this->_getMyPagesModel()->getMyPageTemplateName($pageId));
			$templateWriter->set('template', $content);
	...
	{
		return $this->_getMyPagesModel()->getMyPageTitlePhraseName($pageId);
	}

	protected function _getDescriptionPhraseName($pageId)
	{
		return $this->_getMyPagesModel()->getMyPageDescriptionPhraseName($pageId);
	}
